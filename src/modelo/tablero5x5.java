...
public class tablero5x5 extends JPanel{
    ...
    public void crearTablero(){
        setLayout(null);
        setSize(anchoCI*5+margen*6,alturaCI*5+margen*6); // Ajusta el tamaño para 4x4
    ...
    private void crearCuadrosInternos(){
        ...
        for (int i = 0; i < 5; i++) { // Cambia a 4 filas
            x=margen;
            for (int j = 0; j < 5; j++) { // Cambia a 4 columnas
        ...
        MouseListener evento = new MouseListener() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if(jugadorActual==TipoImagen.EQUIS){
                    ...
                    jugador1.getTablero5()[cuadro.getI()][cuadro.getJ()]=1;
                    tipoImagenResultado = jugador1.cincoEnRaya(jugador2);
                    ...
                    jugador2.getTablero5()[cuadro.getI()][cuadro.getJ()]=1;
                    tipoImagenResultado= jugador2.cincoEnRaya(jugador1);
    ...
    public void cambiarEstilos(TipoImagen jugadorAct){
        if(jugadorAct==TipoImagen.CIRCULO){
            form5x5.imgJugadorEquis.setRuta(Ruta.JUGADORAUXILLAR);
            form5x5.imgJugadorEquis.repaint();
            form5x5.nombreJugadorEquis.setForeground(new Color(240,240,240,100));
            
            form5x5.imgJugadorCirculo.setRuta(Ruta.JUGADORCIRCULO);
            form5x5.imgJugadorCirculo.repaint();
            form5x5.nombreJugadorCirculo.setForeground(new Color(255,200,255));
        }else if(jugadorAct==TipoImagen.EQUIS){
            form5x5.imgJugadorCirculo.setRuta(Ruta.JUGADORAUXILLAR);
            form5x5.imgJugadorCirculo.repaint();
            form5x5.nombreJugadorCirculo.setForeground(new Color(240,240,240,100));
            
            form5x5.imgJugadorEquis.setRuta(Ruta.JUGADOREQUIS);
            form5x5.imgJugadorEquis.repaint();
            form5x5.nombreJugadorEquis.setForeground(new Color(180,232,255));
        }
    }
    ...
    public void reiniciarTablero5(TipoImagen ganador){
        desactivarCuadros(false);
        borrarImagenes();
        cuadroFrontal.setTipoImagen(null);
        if(ganador==TipoImagen.EQUIS){
            int puntajeNuevo= Integer.parseInt(form5x5.puntajeEquis.getText())+1;
            form5x5.puntajeEquis.setText(String.valueOf(puntajeNuevo));
        }
        else if(ganador==TipoImagen.CIRCULO){
             int puntajeNuevo= Integer.parseInt(form5x5.puntajeCirculo.getText())+1;
            form5x5.puntajeCirculo.setText(String.valueOf(puntajeNuevo));
        }
