...
public class FormTikTacToe extends javax.swing.JFrame {
    ...
    public FormTikTacToe(Jugador jugador1,Jugador jugador2) {
        ...
        tablero3.cambiarEstilos(TipoImagen.EQUIS);
    }
    public void init(){
        setUndecorated(true);
        initComponents();
        ...
        tablero3.setJugador1(jugador1);
        tablero3.setJugador2(jugador2);
        tablero3.setAlturaCI(100);
        tablero3.setAnchoCI(100);
        tablero3.setMargen(5);
        tablero3.setColorCI(new Color(14,19,43));
        tablero3.setColorTablero(new Color(239,180,255));
        tablero3.setLocation(40,150);
        tablero3.crearTablero();
        tablero3.setVisible(true);
        
        panelFondo.add(tablero3);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reiniciar juego");
        panelFondo.add(jLabel1);
        jLabel1.setBounds(240, 10, 105, 30);
